...
import {Serializer} from '@openapi-adapter/fetch'


describe('fetch/classes/Serializer', () => {
    ...
    test('cookieParameters', () => {
        const cookieParams: adapter.request.CookieParams = {
        ...
        const serialized = serializer.cookieParameters(cookieParams)
